// Módulo de apoyo para Órdenes de Trabajo.
// Preparado sin activarlo todavía: app.js conserva la implementación activa
// hasta completar la migración de sus dependencias compartidas.
  ...
  function actualizarHistorialExtintores(cliente, selectedIds, fechaServicio, fechaProximo, servicios, observaciones){
    ...
    clientesPerfil = clientesPerfil.map(p=>{
